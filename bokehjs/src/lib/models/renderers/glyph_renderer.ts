...
export class GlyphRendererView extends DataRendererView {
  ...
  set_data(request_render: boolean = true, indices: number[] | null = null): void {
    ...
    this.decimated_glyph.set_data(source, all_indices, indices, this.decimated_glyph instanceof base_type ? this.glyph : undefined)
    this.selection_glyph.set_data(source, all_indices, indices, this.selection_glyph instanceof base_type ? this.glyph : undefined)
    this.nonselection_glyph.set_data(source, all_indices, indices, this.nonselection_glyph instanceof base_type ? this.glyph : undefined)
    this.hover_glyph?.set_data(source, all_indices, indices, this.hover_glyph instanceof base_type ? this.glyph : undefined)
    this.muted_glyph?.set_data(source, all_indices, indices, this.muted_glyph instanceof base_type ? this.glyph : undefined)
